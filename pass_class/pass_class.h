...
private:
  ...
  bool hasTable;
public:
  Table_player(const string & fn = "none",const string & ln = "none",bool ht = false,int ye = 0,int mon = 0);
  void name() const;
...
public:
  Rated_player(unsigned int r,unsigned int t,const string & fn = "none",const string & ln = "none",bool ht = false,int ye = 0,int mon = 0);
